...
namespace QuoteManagement.Api.Test.Data
{
    public class QuoteRequestRepositoryTests
    {
        ...
        public void Initialize()
        {
            ...
            foreach(var quoteRequest in quoteReqestBuilder.ManyRequest())
            {
                quotesDbContext.QuoteRequests.Add(quoteRequest);
            }
        ...
        {
            var request = quoteReqestBuilder.Request();
